...
const Photos = ({ picturesData }) => {
  ...
  const renderPictures = () => (
    picturesData.map((pictureData) => (
      <div className="pictures__box" key={pictureData.id}>
        <div className="pictures__item-box">
          <picture >
            ...
            <img className="pictures__item" src={pictureData.path.mobileView.jpg} alt={pictureData.alt} />
          </picture>
        </div>
        <div className="pictures__hover-box">
          <p className="pictures__author-avatar-wrapper">
            <picture >
              <source media="(min-width: 1560px)" srcSet='images/avatar-desktop.jpg' />
              <img
                className="pictures__author-avatar"
                src='images/avatar-mobile.jpg'
                alt='Автор изображения: Вадим Садовский'
              />
            </picture>
          </p>
          <p className="pictures__author-info">
            <span className="pictures__author-name">Vadim Sadovski</span>
            <span className="pictures__author-account">@vadimsadovski</span>
          </p>
          <p className="pictures__user-actions">
            <button
              type="button"
              className="pictures__add-to-favorite"
            >
              <svg className="pictures__add-to-favorite-icon" width="23" height="21" viewBox="0 0 23 21" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link href={`/photo/${pictureData.id}`}>
              <a className="pictures__maximize">
            ...
            <a className="pictures__download">
