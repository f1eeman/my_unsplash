      ...
      <div className="pictures__item picture" key={pictureData.id}>
        ...
        <div className="picture__hover-box">
          ...
          <p className="picture__author-info">
            <span className="picture__author-name">Vadim Sadovski</span>
            <span className="picture__author-account">@vadimsadovski</span>
          </p>
          <p className="picture__user-actions">
            <button
              type="button"
              className="picture__add-to-favorite"
            >
              <svg className="picture__add-to-favorite-icon" width="23" height="21" viewBox="0 0 23 21" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link href={`/photo/${pictureData.id}`}>
              <a className="picture__maximize">
                <svg className="picture__maximize-icon" width="37" height="36" viewBox="0 0 37 36" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <a className="picture__download">
              <svg className="picture__download-icon" width="20" height="26" viewBox="0 0 20 26" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
