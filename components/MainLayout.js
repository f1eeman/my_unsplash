...
const MainLayout = ({
  ...
  const mainTitleClasses = cn({
    'visually-hidden': mainTitle.visability === 'hidden',
    'page-main__title': mainTitle.visability === 'visible',
  })

  const renderSearchPageLink = () => {
    if (thisPage === 'searchPage') {
      return null;
    }
    return (
  ...
  const renderFavoritesPageLink = () => {
    if (thisPage === 'favoritesPage') {
      return null;
    }
    return (
      <li className="site-list__item">
  ...
  return (
    <>
        ...
        <div className="container">
          <nav className="page-header__main-nav main-nav">
              ...
              <a className="main-nav__logo">
                <p className="main-nav__icon-wrapper">
                  <img
                    ...
                    src={thisPage === 'innerPage' ? "../images/logo-icon.svg" : "images/logo-icon.svg"}
                    width="29"
                    height="29"
                ...
                <p className="main-nav__text-wrapper">
                  <img
                    ...
                    src={thisPage === 'innerPage' ? "../images/logo-text.png" : "images/logo-text.png"}
                    width="133"
                    height="23"
                    alt="Логотип сервиса ImageStock"
                  />
            ...
            <ul className="main-nav__list site-list">
              {renderSearchPageLink()}
              {renderFavoritesPageLink()}
              <li className="site-list__item">
                <p className="site-list__link-wrapper">
                  <Link href="/history">
                    <a className="site-list__link">
      ...
      <main className="page-main">
        <h1 className={mainTitleClasses}>{mainTitle.text}</h1>
        {children}
      </main>
    </>
  );
